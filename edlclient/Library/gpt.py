...
class gpt(metaclass=LogBase):
    ...
    def patch(self, data:bytes, partitionname="boot", active: bool = True):
        ...
        t_inactive = "b"
        data_types = {
            f"system_{t_active}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"xbl_{t_active}" : b'2cbaa0deddcb0548b4f9f428251c3e98',
            f"xbl_config_{t_active}" : b'e45a325a76426db60add3494df27706a',
            f"aop_{t_active}" : b'a5909ed6ab4c7100f6dfab977f141a7f',
            f"tz_{t_active}" : b'7faa53a0b8401c4bba082f68ac71a4f4',
            f"hyp_{t_active}" : b'89a6a6e18d0cc64cb4e855a4320fbd8a',
            f"modem_{t_active}" : b'a2a0d0ebe5b9334487c068b6b72699c7',
            f"bluetooth_{t_active}" : b'f147b76cefc29240add0ca39f79c7af4',
            f"mdtpsecapp_{t_active}" : b'80d602ea12875245a3bee6087829c1e6',
            f"mdtp_{t_active}" : b'8a40783863e2674bb8786340b35b11e3',
            f"abl_{t_active}" : b'a12869bde04c38a04f3a1495e3eddffb',
            f"dsp_{t_active}" : b'1050fe7e1a2a1a4ab8bc990257813512',
            f"keymaster_{t_active}" : b'7c2a1da12ad82f4c8a011805240e6626',
            f"boot_{t_active}" : b'867f112085e95743b9ee374bc1d8487d',
            f"cmnlib_{t_active}" : b'9517477354abf943a8474f72ea5cbef5',
            f"cmnlib64_{t_active}" : b'9348a68e67121b4a947c7c362acaad2c',
            f"devcfg_{t_active}" : b'164b5df63d34254eaafcbe99b6556a6d',
            f"qupfw_{t_active}" : b'9f21d121d12eb44a930a41a16ae75f7f',
            f"storsec_{t_active}" : b'fe45db021badb64caecc0042c637defa',
            f"ImageFv_{t_active}" : b'77119117e6c97243933c804b678e666f',

            f"system_{t_inactive}" : b'11b0d797da543548b3c4917ad6e73d74',
            f"xbl_{t_inactive}" : b'2cbaa0deddcb0548b4f9f428251c3e98',
            f"xbl_config_{t_inactive}" : b'e45a325a76426db60add3494df27706a',
            f"aop_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"tz_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"hyp_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"modem_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"bluetooth_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"mdtpsecapp_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"mdtp_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"abl_{t_inactive}" : b'77b014415d00124eac8cb493bda684fb',
            f"dsp_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"keymaster_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"boot_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"cmnlib_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"cmnlib64_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"devcfg_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"qupfw_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"storsec_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
            f"ImageFv_{t_inactive}" : b'd46c0377d503bb428ed137e5a88baa34',
        ...
        inactiveslot = "b"
        data_flags = {
            f"system_{activeslot}" : 1125899906842624,
            f"xbl_{activeslot}" : 1170654428139618304,
            f"xbl_config_{activeslot}" : 17732923532771328,
            f"aop_{activeslot}" : 17732923532771328,
            f"tz_{activeslot}" : 17732923532771328,
            f"hyp_{activeslot}" : 17732923532771328,
            f"modem_{activeslot}" : 1170654428139618304,
            f"bluetooth_{activeslot}" : 1170654428139618304,
            f"mdtpsecapp_{activeslot}" : 1170654428139618304,
            f"mdtp_{activeslot}" : 1170654428139618304,
            f"abl_{activeslot}" : 1170654428139618304,
            f"dsp_{activeslot}" : 1170654428139618304,
            f"keymaster_{activeslot}" : 1170654428139618304,
            f"boot_{activeslot}" : 33495522228568064,
            f"cmnlib_{activeslot}" : 1170654428139618304,
            f"cmnlib64_{activeslot}" : 1170654428139618304,
            f"devcfg_{activeslot}" : 17732923532771328,
            f"qupfw_{activeslot}" : 17732923532771328,
            f"storsec_{activeslot}" : 17732923532771328,
            f"ImageFv_{activeslot}" : 17732923532771328,

            f"system_{inactiveslot}" : 0,
            f"xbl_{inactiveslot}" : 1168965578279354368,
            f"xbl_config_{inactiveslot}" : 16044073672507392,
            f"aop_{inactiveslot}" : 1168965578279354368,
            f"tz_{inactiveslot}" : 1168965578279354368,
            f"hyp_{inactiveslot}" : 16044073672507392,
            f"modem_{inactiveslot}" : 1168965578279354368,
            f"bluetooth_{inactiveslot}" : 1168965578279354368,
            f"mdtpsecapp_{inactiveslot}" : 1168965578279354368,
            f"mdtp_{inactiveslot}" : 1168965578279354368,
            f"abl_{inactiveslot}" : 1168965578279354368,
            f"dsp_{inactiveslot}" : 1168965578279354368,
            f"keymaster_{inactiveslot}" : 1168965578279354368,
            f"boot_{inactiveslot}" : 31806672368304128,
            f"cmnlib_{inactiveslot}" : 1168965578279354368,
            f"cmnlib64_{inactiveslot}" : 1168965578279354368,
            f"devcfg_{inactiveslot}" : 16044073672507392,
            f"qupfw_{inactiveslot}" : 16044073672507392,
            f"storsec_{inactiveslot}" : 16044073672507392,
            f"ImageFv_{inactiveslot}" : 16044073672507392,
        }
